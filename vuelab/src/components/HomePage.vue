            ...
            <div className="logo">
                ...
                <div className="restart">
                    <p>
                        ...
                        Comics, Series. You can View List of each respectively
                        from the links below.
                        <!-- You can search matching Character,
                        comics, series by keywords. -->
                    </p>
                </div>
...
@import url('https://fonts.googleapis.com/css?family=Barlow+Condensed:500,800');
.images {
    pointer-events: none;
    height: 100vh;
    top: 0;
...
.wrapper.run-animation .button {
    opacity: 0;
    -webkit-animation: fade-down 1200ms ease 3600ms forwards;
    animation: fade-down 1200ms ease 3600ms forwards;
}
.wrapper.run-animation ~ .images {
    -webkit-animation: flicker-images 1500ms 2 steps(1, end),
        fade-out 4500ms forwards;
...
@keyframes flicker-images {
    ...
    /* 10% {
        background-image: url('http://doomrocket.com/wp-content/uploads/2014/08/IMG_4527.png');
    } */
    20% {
        background-image: url('https://www.nerdmuch.com/wp-content/uploads/2016/02/funny-deadpool.jpg');
    }
